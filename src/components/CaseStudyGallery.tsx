      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <Carousel className="w-full">
            ...
            <CarouselPrevious className="md:hidden flex text-black hover:text-white h-12 w-12 -left-2 top-[60%] z-10" />
            <CarouselNext className="md:hidden flex text-black hover:text-white h-12 w-12 -right-2 top-[60%] z-10" />
          </Carousel>
