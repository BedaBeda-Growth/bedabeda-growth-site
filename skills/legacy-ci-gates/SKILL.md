---
name: "Legacy CI Gates"
description: "Run repo-specific preflight, quick, and full CI gate checks for legacy with production-safety blocking."
alwaysAllow:
  - Bash
  - Read
globs:
...
Primary target repo:
- `/Users/nicholaspetros/SOS/SOS 2/portal`
