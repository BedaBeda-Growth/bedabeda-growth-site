---
name: "Pinchpay CI Gates"
description: "Run repo-specific preflight, quick, and full CI gate checks for pinchpay with production-safety blocking."
alwaysAllow:
  - Bash
  - Read
globs:
...
Primary target repo:
- `/Users/nicholaspetros/SOS/pinch-pay-dash`
