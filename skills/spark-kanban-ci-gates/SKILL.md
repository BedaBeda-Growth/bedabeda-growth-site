---
name: "Spark Kanban CI Gates"
description: "Run repo-specific preflight, quick, and full CI gate checks for spark-kanban with production-safety blocking."
alwaysAllow:
  - Bash
  - Read
globs:
...
Primary target repo:
- `/Users/nicholaspetros/SOS/MIni SOS/spark-kanban`
...
0. `cat .agents/workflows/qa-rules.md` and explicitly confirm the changes committed do not violate any business rules defined within the QA rules.
...
## full
From repo root:
0. Run `cat .agents/workflows/qa-rules.md` and explicitly confirm changes do not violate business rules.
